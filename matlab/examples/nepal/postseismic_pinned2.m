...
gpsdata=cell(4,1);
gpsdata{1} = importdata('./gps_old/KKN4out.dat');
gpsdata{2} = importdata('./gps_old/NASTout.dat');
gpsdata{3} = importdata('./gps_old/CHLMout.dat');
gpsdata{4} = importdata('./gps_old/SNDLout.dat');

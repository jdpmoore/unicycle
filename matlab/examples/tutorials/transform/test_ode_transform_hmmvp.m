...
rcv=geometry.receiver('./faults/receiver_fine');
...
src=geometry.source('./faults/transform.flt');
...
evl=ode.hmmvp.rateandstate(src,rcv,evt,G,nu);
...
if options.plotGpsTimeSeries
    ...
    gps=unicycle.manifold.okada85.gps('./gps/dense_network.dat',evl,3);

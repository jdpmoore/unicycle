classdef rateStrengtheningMaxwell < unicycle.ode.evolution
        %% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
    ...
    methods
        ...
        %                                  %
        % % % % % % % % % % % % % % % % % %%
        function obj=rateStrengtheningMaxwell(src,flt,shz,evts,varargin)
            % RATESTRENGTHENINGMAXWELL is a class encapsulating the geometry 
            ...
            obj=obj@unicycle.ode.evolution(src,flt,shz,evts,varargin);

...
%             end
        ...
        function plotPrincipalDirections(obj, sigma, sc, varargin)
            % PLOTPRINCIPALDIRECTIONS plot principal directions of tensor
            ...
            quiver3(X - u1/2, Y - v1/2, Z - w1/2, u1,v1,w1,0,'r','ShowArrowHead','off');

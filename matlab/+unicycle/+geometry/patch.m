classdef patch < handle
    ...
    methods
        ...
        function plotPatch(obj,varargin)
            ...
            if nargin > 1
                ...
                [xp,yp,zp,up]=unicycle.geometry.transform4patch_general(...
                    ...
                    obj.L(:),obj.W(:),obj.dip(:),obj.strike(:));
                patch(xp,yp,-zp,0*up,'FaceColor','None','LineWidth',0.1);
        ...
        % EXAMPLE:                                                   %
        %                                                            %
        %   flt.exportSideXYZ(1,1e-3,'output/flt.xyz',value)         %
        %                                                            %
        % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %%
        function exportSideXYZ(o,sideIndex,scale,fname,field)
            ...
            for k=1:3
                switch sideIndex
                    case 1
                        xyz{k}=[ ...
                            o.xc(:,k)-o.sv(:,k).*o.L/2+o.dv(:,k).*o.W/2, ...
                            o.xc(:,k)+o.sv(:,k).*o.L/2+o.dv(:,k).*o.W/2, ...
                            o.xc(:,k)+o.sv(:,k).*o.L/2+o.dv(:,k).*o.W/2, ...
                            o.xc(:,k)-o.sv(:,k).*o.L/2+o.dv(:,k).*o.W/2, ...
                            ]';
            ...
            fid=fopen(fname,'wt');
            fprintf(fid,'# export from unicycle.geometry.patch.exportSideXYZ\n');
        ...
        % EXAMPLE:                                                   %
        %                                                            %
        %   flt.exportXYZ(1e-3,'output/flt.xyz',value)   %
        %                                                            %
        % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %%

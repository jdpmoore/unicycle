function [x,y,z]=grd(file)
%GRDREAD  Load a GMT grdfile (netcdf format)
%
...
%
% Z=GRDREAD('filename.grd') will return the data as a matrix in Z
%
% [X,Y,Z]=GRDREAD('filename.grd') will also return X and Y vectors
...
switch nargout
    ...
    case 3
        ...
        varargout{3}=z;
    otherwise
        error('grdread: Incorrect # of output arguments!');
end

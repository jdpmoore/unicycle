function [x,r,g,info] = lasso(A,b,tau,options )
%LASSO  Solve the LASSO problem
%
%   LASSO is designed to solve the LASSO problem
%
...
%                                  v = A'*w  if mode == 2. 
%   
%   X = LASSO(A,B,TAU) solves the LASSO problem.
%
%   X = LASSO(A,B,TAU,OPTIONS) specifies options that are set using
%   SETPARAMS.
%
%   [X,R,G,INFO] = LASSO(A,B,TAU,OPTIONS) additionally returns the
...
%
%   See also spgl1, setParams, bp, bpdn.

%   Copyright 2008, Ewout van den Berg and Michael P. Friedlander
%   http://www.cs.ubc.ca/labs/scl/spgl1
%   $Id: lasso.m 1074 2008-08-19 05:24:28Z ewout78 $

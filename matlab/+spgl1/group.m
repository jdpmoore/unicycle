function [x,r,g,info] = group( A, b, groups, sigma, options )
%GROUP  Solve jointly-sparse basis pursuit denoise (BPDN)
%
%   GROUP is designed to solve the basis pursuit denoise problem
%
...
%                                  v = A'*w  if mode == 2. 
%   
%   X = GROUP(A,B,G,SIGMA) solves the BPDN problem.  If SIGMA=0,
...
%
%   X = GROUP(A,B,G,SIGMA,OPTIONS) specifies options that are set
%   using SETPARAMS.
%
%   [X,R,G,INFO] = GROUP(A,B,GROUPS,SIGMA,OPTIONS) additionally

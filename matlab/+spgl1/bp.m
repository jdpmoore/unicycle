function [x,r,g,info] = bp(A,b,options )
%BP  Solve the basis pursuit (BP) problem
%
%   BP is designed to solve the basis pursuit problem
%
...
%                                  v = A'*w  if mode == 2. 
%   
%   X = BP(A,B) solves the BP problem.
%
%   X = BP(A,B,OPTIONS) specifies options that are set using
%   SETPARAMS.
%
%   [X,R,G,INFO] = BP(A,B,OPTIONS) additionally returns the
...
%
%   See also spgl1, setParams, bpdn, lasso.

%   Copyright 2008, Ewout van den Berg and Michael P. Friedlander
%   http://www.cs.ubc.ca/labs/scl/spgl1
%   $Id: bp.m 1074 2008-08-19 05:24:28Z ewout78 $

...
%SETPARAMS  Set options for SPGL1
%
%   options = setParams('param1',val1,'param2',val2,...) creates an
...
%   values are used.
%   
%   setParams with no input arguments and no output arguments
%   displays all parameter names and their possible values.
%
%   options = setParams (with no input arguments) creates an options
%   structure where all the fields are empty.
%
%   setParams.m
%   $Id: setParams.m 1407 2009-06-30 20:00:54Z ewout78 $

% Print out possible values of properties.
if nargin == 0 && nargout == 0
   fprintf(' Default parameters for l1Set.m:\n');
   fprintf('        fid : [ positive integer        |     1 ]\n');
   fprintf('  verbosity : [ integer: 1, 2, or 3     |     0 ]\n');

...
CONTAINS
  ...
  SUBROUTINE RKQSm(n,t,y,dydt,yscal,ycand,yerr,ytmp,htry,hdid,hnext,odefun)
    ...
    REAL*8, PARAMETER    :: SAFETY=0.70d0, &
                            PGROW=-0.20d0, &
                            PSHRNK=-0.15d0, &
                            ERRCON=1.890d-4
    INTEGER              :: i,ierr
  ...
  SUBROUTINE RKCKm(n,t,yin,dydt,h,yout,yerr,ytmp,odefun)
    ...
    REAL*8, PARAMETER :: A2=0.20d0, &
                         A3=0.30d0, &
                         A4=0.60d0, &
                         A5=1.0d0, &
                         A6=0.8750d0
    REAL*8, PARAMETER :: B21=0.2d0, &
                         B31=3.0d0/40.0d0, &
                         B32=9.0d0/40.0d0
    REAL*8, PARAMETER :: B41=0.30d0, &
                         B42=-0.90d0, &
                         B43=1.20d0
    REAL*8, PARAMETER :: B51=-11.0d0/54.0d0, &
                         B52=2.50d0, &
                         B53=-70.0d0/27.0d0, &
                         B54=35.0d0/27.0d0  
    REAL*8, PARAMETER :: B61=1631.0d0/55296.0d0, &
                         B62=175.0d0/512.0d0, &
                         B63=575.0d0/13824.0d0, &
                         B64=44275.0d0/110592.0d0, &
                         B65=253.0d0/4096.0d0
    REAL*8, PARAMETER :: C1=37.0d0/378.0d0, &
                         C3=250.0d0/621.0d0, &
                         C4=125.0d0/594.0d0, &
                         C6=512.0d0/1771.0d0
    REAL*8, PARAMETER :: DC1=C1-2825.0d0/27648.0d0, &

...
CONTAINS
  ...
  !! calculates the traction kernels associated with a strain volumes in
  !! plane strain using James D P Moore's analytic solution published in
  !!
  ...
  !! volumes in plane strain using James D P Moore's analytic solution 
  !! published in 
  !!
  !!   Barbot S., J. D. P. Moore and V. Lambert, Displacement and Stress
  !!   Associated with Distributed Anelastic Deformation in a Half Space,

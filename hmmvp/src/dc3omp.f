...
C     AMB Jun 2013. Add a char arg SPACE to DC3D that switches between
C       halfspace and fullspace solutions.
...
C                                                                       
     ...
     *         UX,UY,UZ,UXX,UYX,UZX,UXY,UYY,UZY,UXZ,UYZ,UZZ
      ...
      CAW1=AW1
      CAW2=AW2
      CALL DC3D1(SPACE,ALPHA,CX,CY,Z,DEPTH,CDIP,                           
     ...
     *     UX,UY,UZ,UXX,UYX,UZX,UXY,UYY,UZY,UXZ,UYZ,UZZ)
      ...
      RETURN
      END                                                
      SUBROUTINE  DC3D1(SPACE,ALPHA,X,Y,Z,DEPTH,DIP,                           
     *                  AL1,AL2,AW1,AW2,DISL1,DISL2,DISL3,               
     *                  UX,UY,UZ,UXX,UYX,UZX,UXY,UYY,UZY,UXZ,UYZ,UZZ)
      IMPLICIT REAL*8 (A-H,O-Z)                                         
      REAL*8   ALPHA,X,Y,Z,DEPTH,DIP,AL1,AL2,AW1,AW2,DISL1,DISL2,DISL3,
...
C=====  IMAGE-SOURCE CONTRIBUTION  =====                                
C=======================================                                
      IF (SPACE.NE.'H' .AND. SPACE.NE.'h') GO TO 335
      ZZ=Z                                                              
      D=DEPTH-Z                                                         
      P=Y*CD+D*SD                                                       
      Q=Y*SD-D*CD                                                       
